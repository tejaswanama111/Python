...
def game(): 
	...
	words = ['programming', 'coding', 'algorithm', 
			'systems', 'python', 'software', 'hardware', 'brain', 'speed', 'test', 'webcam',
            'keyboard', 'mouse', 'pendrive', 'ram', 'rom', 'javascript', 'java', 'virus', 'malware',
            'php', 'data', 'internet', 'website', 'laptop', 'desktop', 'ports', 'robot', 'glass', 'school',
            'science', 'maths', 'english', 'hindi', 'sst', 'sanskrit', 'parallelogram', 'graph', 'games'] 
